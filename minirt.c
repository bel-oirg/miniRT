...
/*   Updated: 2024/08/02 09:07:14 by bel-oirg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_world setup_world()
{
	...
	new_w.spheres = init_sphere(0.6, get_tup(0, 0, 0, 0), get_tup(1, 0, 1, 0));
	...
	while (++y < HEIGHT)
	{
		...
		while (++x < WIDTH)
		{
			...
			*/
			...
			final_col = trgb_uint(col_t.t[0], col_t.t[1], col_t.t[2], col_t.t[3]);
